...
public class Calculations {
    ...
    private static final String[] POINTS_ARRAY = { "0", "1", "3", "6", "10", "15", "21", "28", "36", "45", "55", "66",
            "78" };
    ...
    protected int calculateRedPoints(String fileName) {
        ...
        // adding all the point from a normal Array to an ArrayList for simple
        // calculations
    ...
    // method gets the file/player name and calls for the penalty list from the
    // Connector class
