...
public class Connector {
    ...
    // This method saves the path of newly generated player file to the specific
    ...
    // This method searches for the last saved path of a specific player file and
    ...
    // This method reads the last line from the diceRoll file and returns it as a
    // String
    ...
    // This method gets the six generated random numbers and saves it into the
    // diceRoll CSV file
    ...
    // This method gets the file name and color and returns all numbers of that
    // color
    ...
    public void addPenalty(String fileName) {
        ...
        for (int i = 0; i < colors.length; i++) {
            if (get_A_Number(fileName, colors[i], "P").equalsIgnoreCase("P")) {
                ...
                aL.set(12, "Y");
                String a = "" + aL;
                // cuts the first and the last character from the String, which are the
                // parantheses
                String b = a.substring(1, a.length() - 1);
                // eleminates all the spaces from the String so there would be no problem in CSV
                // file
    ...
    // This method checks if the selected Number can be crossed and crosses if
    // possible
    ...
    // This method gets the player name, color and the chosen number and crosses it
    // in the file
