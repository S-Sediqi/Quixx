...
public class DicePage extends JFrame implements ActionListener {
    ...
    public DicePage(GameProcess process) {
        ...
        // title_Lb.setBorder(new BevelBorder(BevelBorder.RAISED, Color.ORANGE,
        // Color.ORANGE));
        c.add(title_Lb);
        ...
        if (playerNumber >= 3) {
            ...
            p3_Name_Lb = new JLabel(process.getPassivePlayerName(process.getPassivePlayer().get(1)),
        ...
        if (playerNumber >= 4) {
            ...
            p4_Name_Lb = new JLabel(process.getPassivePlayerName(process.getPassivePlayer().get(2)),
                    SwingConstants.CENTER);
        ...
        if (playerNumber == 5) {
            ...
            p5_Name_Lb = new JLabel(process.getPassivePlayerName(process.getPassivePlayer().get(3)),
                    SwingConstants.CENTER);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == continue_Bt) {
            ...
            int choice = JOptionPane.showConfirmDialog(null,
                    "Do you want to Exit from the Game?\n\nWarning: All data will be DELETED !",
