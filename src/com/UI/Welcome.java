...
public class Welcome extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == continue_Bt) {
            if (p2_RBt.isSelected() || p3_RBt.isSelected() || 
                p4_RBt.isSelected() || p5_RBt.isSelected()) {
                int numberPlayers = 0;
                Connector cnn = new Connector();
                if (p2_RBt.isSelected()) {
                    cnn.createEverything(2);
                    numberPlayers = 2;
                }
                if (p3_RBt.isSelected()) {
                    cnn.createEverything(3);
                    numberPlayers = 3;
                }
                if (p4_RBt.isSelected()) {
                    cnn.createEverything(4);
                    numberPlayers = 4;
                }
                if (p5_RBt.isSelected()) {
                    cnn.createEverything(5);
                    numberPlayers = 5;
                }
