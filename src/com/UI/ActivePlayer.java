    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == continue02_Bt) {
            if (cRed_Rbt.isSelected()) {
                if (cnn.checkColoredNumberCross("red", cNumber_Tf.getText()) 
                && cnn.checkNumberCross(activePlayer, "red", cNumber_Tf.getText())){
                    cnn.crossANumber(activePlayer, "red", "" + cNumber_Tf.getText());
                } else {
                    warning_Ta.setText("Number cannot be crossed with the\ncolored dice like this!");
                    end = false;
                }
            }

            if (cYellow_Rbt.isSelected()) {
                if (cnn.checkColoredNumberCross("yel", cNumber_Tf.getText()) 
                && cnn.checkNumberCross(activePlayer, "yel", cNumber_Tf.getText())){
            ...
            if (cGreen_Rbt.isSelected()) {
                if (cnn.checkColoredNumberCross("gre", cNumber_Tf.getText()) 
                && cnn.checkNumberCross(activePlayer, "gre", cNumber_Tf.getText())){
            ...
            if (cBlue_Rbt.isSelected()) {
                if (cnn.checkColoredNumberCross("blu", cNumber_Tf.getText()) 
                && cnn.checkNumberCross(activePlayer, "blu", cNumber_Tf.getText())){
